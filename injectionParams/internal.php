...
function injectionParams()
{
    ...
    $delegates = [
        ...
        \Twig_Environment::class => 'createTwigForAdminInternal',
        \Twig\Environment::class => 'createTwigForAdminInternal',
        \Osf\MemoryWarningCheck\MemoryWarningCheck::class => 'createMemoryWarningCheck',
        \SlimAuryn\Routes::class => 'createRoutesForInternal',
        \SlimAuryn\ExceptionMiddleware::class => 'createExceptionMiddlewareForInternalSite',

        \Slim\App::class => 'createSlimAppForInternal',
