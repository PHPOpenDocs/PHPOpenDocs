...
class ContentLinkLevel1 implements InputParameterList
{
    use CreateFromArray;
     ...
     * @param ContentLinkLevel2[]|null $children
     */
    ...
    public static function getInputParameterList(): array
    {
        return [
            ...
            new InputParameter(
                'children',
                new GetArrayOfTypeOrNull(ContentLinkLevel2::class),
            ),
        ];
    }
}
